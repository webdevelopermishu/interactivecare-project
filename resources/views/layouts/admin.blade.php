                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box horizontal-logo">
                            <a href="index.html" class="logo logo-dark">
                                {{--  <span class="logo-sm">
                                    <img width="200px" src="{{asset('backend')}}/images/logo-sm.png" alt="" height="100">
                                </span>
                                <span class="logo-lg">
                                    <img width="200px" src="{{asset('backend')}}/images/logo-dark.png" alt="" height="80">
                                </span>  --}}
                            </a>

                            <a href="index.html" class="logo logo-light">
                                {{--  <span class="logo-sm">
                                    <img src="{{asset('backend')}}/images/logo-sm.png" alt="" height="100">
                                </span>
                                <span class="logo-lg">
                                    <img src="{{asset('backend')}}/images/logo-light.png" alt="" height="80">
                                </span>  --}}
                            </a>
                        </div>
                        ...
                        <div class="dropdown ms-sm-3 header-item topbar-user">
                            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="d-flex align-items-center">
                                    ...
                                    @else
                                        <img class="rounded-circle header-profile-user" src="{{ asset('uploads/users/') }}/{{ Auth::user()->photo }}" alt="profile">
                                    @endif
        ...
        <!-- /.modal -->
                ...
                <div class="app-menu navbar-menu">
                    ...
                    <div class="navbar-brand-box">
                        ...
                        <a href="index.html" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="{{asset('backend')}}/images/logo-sm.png" alt="" height="50">
                            </span>
                            <span class="logo-lg">
                ...
                <div class="main-content">
                    ...
                    <footer class="footer">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-sm-6">
                                    <script>document.write(new Date().getFullYear())</script> © Towfique.
                                </div>
                                <div class="col-sm-6">
                                    <div class="text-sm-end d-none d-sm-block">
                                        Design & Develop by Towfique Mirpur, Dhaka
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-settings-offcanvas">
                        ...
                        <div class="d-flex gap-2 flex-wrap img-switch">
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-01">
                                    <img src="{{asset('backend')}}/images/sidebar/img-1.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            ...
                            <div class="form-check sidebar-setting card-radio">
                                ...
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-02">
                                    <img src="{{asset('backend')}}/images/sidebar/img-2.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-03" value="img-3">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-03">
                                    <img src="{{asset('backend')}}/images/sidebar/img-3.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                            <div class="form-check sidebar-setting card-radio">
                                <input class="form-check-input" type="radio" name="data-sidebar-image" id="sidebarimg-04" value="img-4">
                                <label class="form-check-label p-0 avatar-sm h-auto" for="sidebarimg-04">
                                    <img src="{{asset('backend')}}/images/sidebar/img-4.jpg" alt="" class="avatar-md w-auto object-fit-cover">
                                </label>
                            </div>
                        </div>
                    </div>
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="" target="_blank" class="btn btn-primary w-100">Towfique</a>
                </div>
            </div>
        </div>
    </div>
